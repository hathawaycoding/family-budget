...
const nav = [
  ["Dashboard", "/dashboard"], ["Guide", "/guide"], ["Cash Flow", "/cash-flow"], ["Calendar", "/calendar"], ["Income", "/income"], ["Bills", "/bills"], ["Spending", "/spending"], ["Future Expenses", "/future-expenses"], ["Savings", "/savings"], ["Debt", "/debt"], ["Reports", "/reports"], ["Setup", "/setup"], ["Notes", "/notes"], ["Audit History", "/audit-history"]
];
