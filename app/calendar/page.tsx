...
export default async function CalendarPage() {
  const { bills, income, plannedExpenses, savingsActivities, cashFlowRows } = await getMonthBundle("2026-07");
